<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					...
					<div class="left-sidebar">
						<h2 class="title text-center">Créer une catégorie</h2>

						<div class="loader"><h1>Chargement en cours</h1></div>
						
						<div class="signup-form">						    
						    <form class="formulaire_recette" method="post" action="<?php echo site_url('administration/ajouter_categorie'); ?>">

													    	

						    	<label for="categorie">Nom de la catégorie* :</label>
						        <input type="text" name="categorie" id="categorie" required placeholder="Nom de la catégorie" value="<?php echo set_value('categorie'); ?>"></input>
