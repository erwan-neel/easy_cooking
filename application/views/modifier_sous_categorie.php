				...
				<div class="col-sm-9 padding-right">
					...
					<div class="left-sidebar">
						...
						<div class="signup-form">						    
						    <form class="formulaire_recette" method="post" action="<?php echo site_url('administration/modifier_sous_categorie'); ?>">
						        ...
						        <select class="form-control" id="categorie_mere" required name="categorie_mere">
						        	...
						        	<?php foreach ($categories as $categorie) {
						        		...
						        		if($categorie->nom_categorie == $sous_categorie->nom_cat_mere) {

						        			echo "<option selected value=\"".$categorie->nom_categorie."\">".$categorie->nom_categorie."</option>";
						        ...
						        <input type="text" name="categorie_fille" id="categorie_fille" required placeholder="Nom de la sous-catégorie" value="<?php if(isset($sous_categorie)) { echo $sous_categorie->nom_cat_fille; } else { echo set_value('categorie'); }?>"></input>
