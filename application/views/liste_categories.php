							...
							<tbody>
								<?php 
									foreach ($categories as $categorie) {
										...
										echo '<td><a href="'.site_url('administration/modifier_categorie/'.$categorie->id_categorie).'"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></td>';
										echo '<td><a href="'.site_url('administration/supprimer_categorie/'.$categorie->id_categorie).'" id="supprimer_recette" onclick="return confirm(\'Voulez-vous vraiment supprimer cette catégorie ?\');"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></td></tr>';
